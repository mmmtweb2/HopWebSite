/**
 * Security Middleware (MongoDB Version)
 * Calculates user's security level based on ADFS groups and attaches it to request
 */

import User from '../models/User.js';
import ClassificationGroup from '../models/ClassificationGroup.js';
 ...
 *
 * @param {string} modelName - Name of the model to check (e.g., 'App', 'FileResource')
 * @returns {Function} Express middleware function
 */
